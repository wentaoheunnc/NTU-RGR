...
**Step 2**: Download the raw signal files (~14GB) from [123 Cloud Drive](https://www.123865.com/s/95cVTd-bfLcv) and save data to `./dataset`. File path should be `./dataset/dataset/001/...`
...
We have also uploaded the image files of generated spectrograms/CVDs to [123 Cloud Drive](https://www.123865.com/s/95cVTd-ZfLcv). Alternatively, you may use the image dataset with customized train/test partitions.
